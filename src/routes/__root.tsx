...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "São João de Arcoverde: programação, polos, mapa, gastronomia e hospedagem.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c745a4e1-3a7e-407a-80c5-5c2570a4ed03",
      },
      {
        name: "twitter:image",
        content:
